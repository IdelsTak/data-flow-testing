...
public class LeapYear {
	...
	/**
	 * This method identifies leap years in the given range of years, stores them into an array and 
	 * orders the array elements in ascending order. Finally returns this ordered array.
	 * @param startYear The starting year of the leap year range.
	 * @param endYear The ending year of the leap year range.	 
	 * @return an ordered array of leap years. The rest (unfilled out of size 100) of the array (all trailing) elements should be left as 0s.
	 * @throws IllegalArgumentException if the year is "invalid" or out of 1618-2021 year range
	*/	
